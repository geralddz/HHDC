...
<h6 class="text-white m-b-0">Pendapatan Klinik</h6>
 </div>
<div class="col-4 text-right">
...
<div class="row col-sm-12"><h3>Selamat Datang <?php echo 'Dr. '.$_SESSION['fname']; ?></h3><br><br></div>
<div class="col-xl-3 col-md-6">
<div class="card bg-c-green update-card">
<div class="card-block">
<div class="row align-items-end">
...
<h6 class="text-white m-b-0">Janji Temu Baru</h6>
</div>
<div class="col-4 text-right">
<canvas id="update-chart-2" height="50"></canvas>
</div>
...
<h6 class="text-white m-b-0">Jumlah Pasien</h6>
</div>
<div class="col-4 text-right">
<canvas id="update-chart-3" height="50"></canvas>
</div>
...
<h6 class="text-white m-b-0">Janji Hari Ini
</h6>
</div>
<div class="col-4 text-right">
<canvas id="update-chart-4" height="50"></canvas>
...
<h6 class="text-white m-b-0">Total Penghasilan</h6>
 </div>
<div class="col-4 text-right">
<canvas id="update-chart-1" height="50"></canvas>
</div>
...
?>
  ...
  <div class="row col-lg-12">Selamat Datang di HH Dental Care<br><br></div>
  <div class="card row col-lg-12">
    <div class="card-block">
      <!-- Row start -->
      <div class="row">
        <div class="col-lg-12">
          <div class="sub-title"><h2>Selamat Datang!!</h2></div>
          <!-- Nav tabs -->
          <ul class="nav nav-tabs md-tabs" role="tablist">
              <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#home3" role="tab">Riwayat Registrasi</a>
                  <div class="slide"></div>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#profile3" role="tab">Janji Temu</a>
                  <div class="slide"></div>
              </li>
          </ul>
          <!-- Tab panes -->
          ...
          <div class="tab-content card-block">
              <div class="tab-pane active" id="home3" role="tabpanel">
                  <p class="m-0"><b>Riwayat Registrasi</b>
                  ...
                  <p class="m-0">
                    <b>Janji Temu</b>
                      <?php
                        ...
                        {
                            ?>
                        <h3>Data Janji Temu Tidak ditemukan.. </h3>
                        <?php
                        }
                        else
                        {
                            ?>
                        <h3>Janji Terakhir diambil - <?php echo $rspatientappointment['appointmentdate']; ?>
...
<?php if($_SESSION['user'] == 'admin'){ ?>
  ...
  <tr>
      <th>Detail Pasien</th>
      <th>Tanggal & Waktu Janji Temu</th>
      <th>Departemen</th>
      <th>Dokter</th>
      <th>Alasan</th>
      <th>Status</th>
