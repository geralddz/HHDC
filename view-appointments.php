...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="view-department.php?id=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Ya</a>
      <a href="view-department.php" class="button button--error" data-for="js_success-popup">Tidak</a>
    </p>
  </div>
</div>
<?php } ?>
...
<div class="d-inline">
<h4>Lihat Janji Temu disetujui</h4>
...
<li class="breadcrumb-item"><a>Lihat Janji Temu disetujui</a>
</li>
<li class="breadcrumb-item"><a href="#">Lihat Janji Temu disetujui</a>
</li>
</ul>
</div>
</div>
