...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Data Janji Temu Berhasil diubah.</p>
                <p>
...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Data Janji Temu Berhasil ditambahkan.</p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
...
<li class="breadcrumb-item"><a>Janji Temu</a>
</li>
<li class="breadcrumb-item"><a href="add_user.php">Janji Temu</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    ?>
        ...
        <div class="col-sm-4">
            <select class="form-control" name="department" id="department" placeholder="masukkan nama belakang..." required="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="date" class="form-control" name="appointmentdate" id="appointmentdate" placeholder="masukkan nama depan..." required="">
            <span class="messages"></span>
        </div>

        <label class="col-sm-2 col-form-label">Waktu</label>
        <div class="col-sm-4">
            <input type="time" class="form-control" name="appointmenttime" id="appointmenttime" placeholder="masukkan nama belakang..." required="">
            <span class="messages"></span>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" name="reason" id="reason" placeholder="alasan..." required=""><?php if(isset($_GET['patid']))
