...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Data Waktu Dokter Berhasil diperbarui.</p>
            <p>
...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Data Waktu Dokter Berhasil ditambahkan.</p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
             <?php echo "<script>setTimeout(\"location.href = 'view-visiting-hour.php';\",1500);</script>"; ?>
            </p>
...
<li class="breadcrumb-item"><a>Jam Kunjung</a>
</li>
<li class="breadcrumb-item"><a href="#">Jam Kunjung</a>
</li>
</ul>
</div>
</div>
