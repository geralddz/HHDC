...
?>
     <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>Data Janji Temu Berhasil dihapus.</p>
        <p>
...
?>
     <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>Data Janji Temu Berhasil disetujui.</p>
        <p>
         <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
         <?php echo "<script>setTimeout(\"location.href = 'view-pending-appointment.php';\",1500);</script>"; ?>
        </p>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="view-pending-appointment.php?delid=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Ya</a>
      <a href="view-pending-appointment.php" class="button button--error" data-for="js_success-popup">Tidak</a>
    </p>
  </div>
</div>
<?php } ?>
...
<li class="breadcrumb-item"><a>Laporan Pasien</a>
</li>
...
<div class="card-header">
    <div class="col-sm-10">
        ...
        <a href="add_user.php"><button class="btn btn-primary pull-right">+ Tambah Pengguna</button></a>
        <?php } } ?>
    </div>
<!-- <h5>DOM/Jquery</h5>
  ...
  <div class="row">
      <div class="col-lg-12">
          ...
          <ul class="nav nav-tabs md-tabs tabs-left b-none" role="tablist">
              <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#profile" role="tab">Profil Pasien</a>
                  <div class="slide"></div>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#appointment" role="tab">Data Janji Temu</a>
                  <div class="slide"></div>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#treatment" role="tab">Data Perawatan</a>
                  <div class="slide"></div>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#prescription" role="tab">Data Resep</a>
                  <div class="slide"></div>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#billing" role="tab">Laporan Tagihan</a>
                  <div class="slide"></div>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#payment" role="tab">Laporan Pembayaran</a>
                  <div class="slide"></div>
              </li>
          </ul>
          <!-- Tab panes -->
    ...
    ?>
                    <div class="table-responsive dt-responsive">
                      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                        <tbody>
                          <tr>
                            <th scope="col"><div align="right">Nomor Tagihan &nbsp; </div></th>
                            <td> <?php echo $rsbilling_records['billingid']; ?></td>
                          </tr>
                          <tr>
                            <th width="124" scope="col"><div align="right">Nomor Janji Temu &nbsp; </div></th>
                              <td width="413"> <?php echo $rsbilling_records['appointmentid']; ?>
                              </td>
                          </tr>
                           
                      <tr>
                        <th scope="col"><div align="right">Tanggal Tagihan &nbsp; </div></th>
                        <td>&nbsp;<?php echo $rsbilling_records['billingdate']; ?></td>
                        </tr>
                          
                      <tr>
                        <th scope="col"><div align="right">Waktu Tagihan &nbsp; </div></th>
                      ...
                      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                        <thead>
                         <tr>
                            ...
                            <th width="245" scope="col">Deskripsi</th>
                            <th width="86" scope="col">Jumlah Tagihan</th>
                          </tr>
                          </thead>
                          <tbody>
         <?php
            ...
            ?>
                    ...
                    <div class="table-responsive dt-responsive">
                      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                        <tbody>
                          <tr>
                            <th scope="col"><div align="right">Jumlah Tagihan &nbsp; </div></th>
                            <td>&nbsp;Tk. <?php echo $billamt; ?></td>
                          </tr>
                          <tr>
                            <th width="442" scope="col"><div align="right">Jumlah Pajak (5%) &nbsp; </div></th>
                              <td width="95">&nbsp;Tk. <?php echo $taxamt = 5 * ($billamt / 100); ?>
                              </td>
                          </tr>
                           
                      <tr>
                        <th scope="col"><div align="right">Diskon &nbsp; </div></th>
                        <td>&nbsp;Tk. <?php echo $rsbilling_records['discount']; ?></td>
                        </tr>
                          
                      <tr>
                        <th scope="col"><div align="right">Total Akhir &nbsp; </div></th>
    ...
    ?>
                      ...
                      <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                        <tbody>
                          <tr>
                            <th scope="col"><div align="right">Nomor Tagihan &nbsp; </div></th>
                            <td><?php echo $rsbilling_records['billingid']; ?></td>
                            <td>Nomor Janji Temu &nbsp;</td>
                            <td><?php echo $rsbilling_records['appointmentid']; ?></td>
                          </tr>
                          <tr>
                            <th width="442" scope="col"><div align="right">Tanggal Tagihan &nbsp; </div></th>
                            <td width="413"><?php echo $rsbilling_records['billingdate']; ?></td>
                            <td width="413">Waktu Tagihan &nbsp; </td>
                  ...
                  ?>
                    &nbsp;Tk. <?php echo $billamt; ?></td>
                      ...
                      <tr>
                        <th scope="col"><div align="right">Alasan Diskon</div></th>
                      ...
                      <tr>
                        <th scope="col"><div align="right">Jumlah Pembayaran </div></th>
                        <td>Tk. <?php
                      ...
                      <tr>
                        <th scope="col"><div align="right">Jumlah Saldo</div></th>
                        <td>Tk. <?php echo $balanceamt = $grandtotal - $rspayment[0]  ; ?></td>
                        </tr>
                        </tbody>
                      </table>

                      <p><strong>Laporan pembayaran:</strong></p>
                      <?php
                    ...
                    <?php } ?><br><br>
                     <a class="btn btn-primary" href="paymentdischarge.php?appointmentid=<?php echo $rsappointment[0]; ?>&patientid=<?php echo $_GET['patientid']; ?>">Lakukan Pembayaran</a>
                    </div>
                  </p>
              </div>
          </div>
