...
<label class="col-sm-2 col-form-label">Alamat Portal Perusahaan</label>
<div class="col-sm-4">
...
<div class="form-group row">
<label class="col-sm-2 col-form-label">Simpan Mata Uang</label>
<div class="col-sm-4">
<input type="text" class="form-control" name="curr_sym" id="curr_sym" value="<?php echo $curr_sym;?>" required="">
<span class="messages"></span>
</div>
<label class="col-sm-2 col-form-label">Posisi Mata Uang</label>
<div class="col-sm-4">
<select class="form-control" id="curr_position" name="curr_position" required="">
    <option value="<?php echo "right";?>"<?php if($curr_position=='right'){echo "selected";}?>>Kanan</option>
    <option value="<?php echo "left";?>"<?php if($curr_position=='left'){echo "selected";}?>>Kiri</option>
</select>
<span class="messages"></span>
</div>
</div>
