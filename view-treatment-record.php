...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="view-treatment-record.php?id=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Ya</a>
      <a href="view-treatment-record.php" class="button button--error" data-for="js_success-popup">Tidak</a>
    </p>
  </div>
</div>
<?php } ?>
...
<li class="breadcrumb-item"><a>Lihat Data Perawatan</a>
</li>
<li class="breadcrumb-item"><a href="#">Lihat Data Perawatan</a>
</li>
</ul>
</div>
</div>
...
<thead>
<tr>
    <th width="71"  scope="col">Tipe Perawatan</th>
    <th width="52"  scope="col">Pasien</th>
    <th width="78"  scope="col">Dokter</th>
    <th width="82"  scope="col">Deskripsi Perawatan</th>
    <th width="43"  scope="col">Tanggal Perawatan</th>
    <th width="43"  scope="col">Waktu Perawatan</th>
</tr>
</thead>
<tbody>
  <?php
