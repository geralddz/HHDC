...
if(isset($_GET['delid']))
{
  ...
  {
?>
    <div class="popup popup--icon -success jzs_success-popup popup--visible">
...
<li class="breadcrumb-item"><a>Janji Temu disetujui</a>
</li>
<li class="breadcrumb-item"><a href="view_user.php">Janji Temu disetujui</a>
</li>
</ul>
</div>
</div>
...
<tr>
    <th>Detail Pasien</th>
    <th>Tanggal &  Jam Janji Temu</th>
    <th>Departemen</th>
    <th>Dokter</th>
    <th>Alasan Janji Temu</th>
    <th>Status</th>
