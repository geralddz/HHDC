...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Data Pasien Berhasil dihapus.</p>
            <p>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="view-patient.php?id=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Ya</a>
      <a href="view-patient.php" class="button button--error" data-for="js_success-popup">Tidak</a>
    </p>
  </div>
</div>
<?php } ?>
