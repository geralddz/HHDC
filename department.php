...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Data Departemen Berhasil diperbarui</p>
                <p>
...
?>
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Data Departemen Berhasil ditambahkan.</p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
...
<li class="breadcrumb-item"><a>Departemen</a>
</li>
<li class="breadcrumb-item"><a href="#">Tambah Departemen</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="departmentname" id="departmentname" placeholder="masukkan nama..." required=""  value="<?php if(isset($_GET['editid'])) { echo $rsedit['departmentname']; } ?>" >
