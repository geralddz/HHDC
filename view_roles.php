...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="del_roles.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Ya</a>
      <a href="view_roles.php" class="button button--error" data-for="js_success-popup">Tidak</a>
    </p>
  </div>
</div>
<?php } ?>
...
<li class="breadcrumb-item"><a>Mengelola Peran</a>
</li>
<li class="breadcrumb-item"><a href="view_roles.php">Peran</a>
</li>
</ul>
</div>
</div>
...
<div class="card-header">
    <div class="col-sm-10">
        <a href="assign_roles.php"><button class="btn btn-primary pull-right">+ Tambah Peran</button></a>
    </div>
